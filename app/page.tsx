...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[#3c3679] text-white text-center py-2 px-4 relative">
        <span className="text-sm">This is an announcement banner for you to insert</span>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" className="border-gray-300 text-gray-700 hover:bg-gray-50 px-6 sm:px-8 py-3">
                Book a Demo Today
              </Button>
            </div>
          ...
          <div className="mt-16 text-center">
            <div className="bg-white/10 rounded-2xl p-8 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  variant="outline"
                  className="border-white text-white hover:bg-white hover:text-[#3c3679] px-8 py-3 text-lg font-medium"
                >
                  Schedule Demo
                </Button>
              </div>
