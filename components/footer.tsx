        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              ...
              solutions. Find your next customers with our powerful search and analytics tools.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:support@growvy.com" className="text-gray-300 hover:text-white transition-colors">
                  Email Support
                </a>
              </li>
              <li>
